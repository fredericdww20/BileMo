 ...
 */
final class Version20240227142528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP client_id, DROP password');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD client_id INT NOT NULL, ADD password VARCHAR(255) NOT NULL');
